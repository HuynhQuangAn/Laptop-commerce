...
import styles from "./TintucIPAD.module.css";

const TintucIPAD: FunctionComponent = () => {
  ...
  return (
    <div className={styles.tintucIpad}>
      ...
      <div className={styles.tintucIpadInner}>
