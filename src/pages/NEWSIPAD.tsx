...
import styles from "./NEWSIPAD.module.css";

const NEWSIPAD: FunctionComponent = () => {
  return (
    <div className={styles.newsIpad}>
      <div className={styles.image1Parent}>
        ...
        <img
          ...
          alt=""
          src="/screenshot-20230521-at-1336-11@2x.png"
        />
      </div>
      ...
      <div className={styles.newsIpadInner}>
