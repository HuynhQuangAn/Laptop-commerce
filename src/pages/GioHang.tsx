...
const GioHang: FunctionComponent = () => {
    ...
    <div className={styles.gioHang}>
      <div className={styles.instanceParent}>
        <div className={styles.frameParent}>
          ...
          <img className={styles.instanceChild} alt="" src="/frame-49@2x.png" />
          <div className={styles.macbookPro13InchM210CorWrapper}>
            <div
              className={styles.cngTyCContainer}
          ...
          <div className={styles.frameDiv}>
            <div className={styles.div3}>29.690.000₫</div>
          </div>
          <div className={styles.instanceWrapper}>
        ...
        <div className={styles.frameParent8}>
          ...
          <div className={styles.chnTtCWrapper}>
            <div className={styles.div}>Chọn tất cả</div>
          </div>
          <div className={styles.frameParent9}>
            <div className={styles.instanceWrapper}>
              <img className={styles.vectorIcon} alt="" src="/vector6.svg" />
            </div>
            <div className={styles.div}>Xóa</div>
          </div>
          <div className={styles.tngThanhTonSnPhmWrapper}>
            <div
              className={styles.tngThanhTon}
            >{`Tổng thanh toán sản phẩm: `}</div>
          </div>
          ...
          <div className={styles.frameWrapper}>
            <div
              className={styles.muaHngWrapper}
              onClick={onFrameContainerClick}
            >
              <div className={styles.div}>Mua hàng</div>
            </div>
          </div>
        </div>
      </div>
