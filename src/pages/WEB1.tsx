  ...
  return (
    <div className={styles.web2}>
      ...
      <div className={styles.silde}>
        <div className={styles.itemGroupSlide}>
          <img
            className={styles.sildeItemIcon}
            alt=""
            src="/silde-item@2x.png"
          />
          <img
            className={styles.sildeItemIcon1}
            alt=""
            src="/silde-item1@2x.png"
          />
          <img
            className={styles.sildeItemIcon2}
            alt=""
            src="/silde-item2@2x.png"
          />
          <img
            className={styles.sildeItemIcon3}
            alt=""
            src="/silde-item3@2x.png"
          />
          <img
            className={styles.sildeItemIcon4}
            alt=""
            src="/silde-item4@2x.png"
          />
        </div>
      ...
      <div className={styles.itemList}>
        ...
        <div className={styles.categoryItem2}>
          <div className={styles.categoryItem3}>
            <div className={styles.macWrapper}>
              <b className={styles.thngTin}>Laptop</b>
            </div>
            <div className={styles.itemGrid}>
              <div className={styles.frameParent}>
                <div className={styles.frameGroup}>
                ...
                <div className={styles.frameContainer}>
                  ...
                  <div className={styles.parent}>
                    <b className={styles.thngTin}>
                      <p className={styles.blankLine}>23.590.000₫</p>
                    </b>
                    <b className={styles.b1}>
                      <p className={styles.blankLine}>21.000.000₫</p>
                    </b>
                  </div>
                </div>
              </div>
              <div className={styles.frameParent}>
                ...
                <div className={styles.frameContainer}>
                  ...
                  <div className={styles.parent}>
                    <b className={styles.thngTin}>33.500.000₫</b>
              ...
              <div className={styles.frameParent}>
                ...
                <div className={styles.frameContainer}>
                  ...
                  <div className={styles.parent}>
                    <b className={styles.thngTin}>29.000.000₫</b>
                    <b className={styles.b1}>36.990.000₫</b>
                  </div>
                </div>
              </div>
              <div className={styles.frameParent}>
                ...
                <div className={styles.frameContainer}>
                  ...
                  <div className={styles.parent}>
                    <b className={styles.thngTin}>24.000.000₫</b>
            ...
            <div className={styles.categoryItemInner}>
              <div className={styles.xemTtCPhKinParent}>
                <div className={styles.thngTin}>Xem tất cả Laptop</div>
        ...
        <div className={styles.categoryItem2}>
          <div className={styles.categoryItem3}>
            <div className={styles.macWrapper}>
              <b className={styles.thngTin}>Phụ kiện</b>
            </div>
            <div className={styles.itemGrid}>
              <div className={styles.frameParent}>
                <div className={styles.frameGroup}>
                ...
                <div className={styles.frameContainer}>
                  ...
                  <div className={styles.parent}>
                    <b className={styles.thngTin}>
                      <p className={styles.blankLine}>1.630.000₫</p>
                    </b>
              ...
              <div className={styles.frameParent}>
                ...
                <div className={styles.frameContainer}>
                  ...
                  <div className={styles.parent}>
                    <b className={styles.thngTin}>750.000₫</b>
              ...
              <div className={styles.frameParent}>
                ...
                <div className={styles.frameContainer}>
                  ...
                  <div className={styles.parent}>
                    <b className={styles.thngTin}>3.590.000₫</b>
              ...
              <div className={styles.frameParent}>
                ...
                <div className={styles.frameContainer}>
                  ...
                  <div className={styles.parent}>
                    <b className={styles.thngTin}>2.290.000₫</b>
                    <b className={styles.b1}>2.990.000₫</b>
                  </div>
                </div>
              </div>
            ...
            <div className={styles.categoryItemInner}>
              <div className={styles.xemTtCPhKinParent}>
                <div className={styles.thngTin}>Xem tất cả phụ kiện</div>
                <img className={styles.frameIcon1} alt="" src="/frame.svg" />
              </div>
            </div>
          </div>
        ...
        <div className={styles.categoryItem2}>
          <div className={styles.categoryItem7}>
            <div className={styles.categoryItem8}>
              <div className={styles.macWrapper}>
                <b className={styles.thngTin}>Tin tức</b>
              </div>
                  ...
                  <div className={styles.frameParent34}>
                    ...
                    <div className={styles.frameParent35}>
                      <img
                        ...
                        src="/frame2.svg"
                      />
                      <div className={styles.thngTin}>25/04/2023</div>
                    </div>
                  </div>
                </div>
                <div className={styles.frameParent33}>
                  ...
                  <div className={styles.frameParent34}>
                    ...
                    <div className={styles.frameParent35}>
                      <img
                        ...
                        src="/frame2.svg"
                      />
                      <div className={styles.thngTin}>4 days ago</div>
                    </div>
                  </div>
                </div>
                <div className={styles.frameParent33}>
                  ...
                  <div className={styles.frameParent34}>
                    ...
                    <div className={styles.frameParent35}>
                      <img
                        ...
                        src="/frame2.svg"
                      />
                      <div className={styles.thngTin}>12/05/2023</div>
                    </div>
                  </div>
                </div>
              </div>
              <div className={styles.categoryItemInner}>
                <div className={styles.xemTtCPhKinParent}>
                  <div className={styles.thngTin}>Xem tất cả tin tức</div>
                  <img className={styles.frameIcon1} alt="" src="/frame1.svg" />
                </div>
              </div>
            </div>
        ...
        <div className={styles.headingNewletter1}>
          <div className={styles.categoryItem9}>
            <div className={styles.categoryItem1}>
              <div className={styles.ngKNhnTinTThnkWrapper}>
                <div className={styles.ngKNhnTinTThnk}>
                  ...
                  <div className={styles.ngKNhnTinTThnk1}>
                    <b className={styles.thngTin}>Đăng ký nhận tin từ Th!nk!</b>
                  </div>
                </div>
              </div>
              <div className={styles.categoryItemInner3}>
                <div className={styles.emailCaBnParent}>
                  <div className={styles.thngTin}>Email của bạn</div>
                  <div className={styles.ngKWrapper}>
                    <div className={styles.thngTin}>Đăng ký</div>
                  </div>
                </div>
              </div>
            </div>
