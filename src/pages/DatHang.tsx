...
import styles from "./DatHang.module.css";

const DatHang: FunctionComponent = () => {
  return (
      ...
      <div className={styles.component6}>
        <div className={styles.iconThinkParent}>
          ...
          <div className={styles.iconMac}>
            <div className={styles.checkOut}>Mac</div>
          </div>
          <div className={styles.iconLaptop}>
            <div className={styles.checkOut}>Laptop</div>
          </div>
          <div className={styles.iconLaptop}>
            <div className={styles.checkOut}>Phụ kiện</div>
          </div>
          <div className={styles.iconLaptop}>
            <div className={styles.checkOut}>Tin tức</div>
          </div>
